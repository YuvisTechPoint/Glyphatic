    ...
    <main className="min-h-screen bg-[#0A0D14] pt-24 pb-32">
      ...
      <section className="relative overflow-hidden py-16 lg:py-24 border-b border-white/5">
        ...
        <div className="container-wide relative z-10">
          <FadeInView>
            <h1 className="text-[3rem] lg:text-[4rem] font-display font-bold text-white tracking-tight mb-6">
              Glyphatic Support Hub
            </h1>
            <p className="text-[1.125rem] lg:text-[1.25rem] text-neutral-400 font-medium max-w-2xl leading-relaxed">
          ...
          <FadeInView delay={0.2}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              {SUPPORT_RESOURCES.map((resource, i) => (
                <div 
                  key={i}
                  className="group relative flex flex-col rounded-2xl border border-white/10 bg-[#111111] p-8 lg:p-10 transition-all hover:bg-[#1a1a1a] hover:border-white/20"
                >
                  ...
                  <Link 
                    href={resource.href}
                    className="inline-flex items-center gap-2 text-[15px] font-semibold text-[#FA582D] transition-colors group-hover:text-white"
                  >
      ...
      <section className="py-16" id="ticket">
        <div className="container-wide">
          <FadeInView delay={0.4}>
            <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-[#1a1a1a] to-[#111111] p-8 lg:p-16 text-center">
