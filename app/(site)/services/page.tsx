...
export default function ServicesPage() {
 ...
 <p className="text-[1.125rem] md:text-[1.25rem] text-neutral-600 font-medium max-w-2xl leading-relaxed">
 ...
 className="inline-flex items-center gap-2 text-sm font-bold text-[#FA582D] hover:text-neutral-900 transition-colors"
 >
 ...
 <div className="group relative flex flex-col justify-between h-full rounded-2xl border border-black/10 bg-gray-50 p-8 transition-all hover:border-black/20 hover:bg-[#161616]">
 <div>
 ...
 <div>
 <div className="space-y-2 mb-8 border-t border-black/5 pt-6">
 ...
 <Link
 href={service.href}
 className="inline-flex items-center gap-2 text-sm font-bold text-[#FA582D] group-hover:text-neutral-900 transition-colors"
 >
 ...
 <div className="rounded-2xl border border-black/5 bg-white p-8 h-full">
 <div className="text-3xl font-display font-bold text-[#FA582D] mb-4">
 {m.step}
 </div>
 <h3 className="text-lg font-bold text-neutral-900 mb-2">{m.title}</h3>
 ...
 <div className="container-wide">
 <FadeInView>
 <div className="rounded-3xl border border-black/10 bg-gradient-to-br from-[#1a1a1a] via-[#111111] to-[#0A0D14] p-10 lg:p-16 flex flex-col lg:flex-row justify-between items-center gap-8 shadow-2xl relative overflow-hidden">
