...
export default function DiscussArchitecturePage() {
 ...
 <div key={idx} className="flex gap-4 p-5 rounded-xl border border-black/5 bg-white transition-colors hover:border-black/10">
 ...
 <div className="rounded-2xl border border-black/10 bg-gradient-to-br from-[#161616] to-[#0A0D14] p-6 mt-8">
 <h4 className="text-sm font-bold text-neutral-900 uppercase tracking-wider mb-3">Our Engineering Guarantee</h4>
 ...
 <div className="rounded-[24px] border border-black/10 bg-white p-8 md:p-10 shadow-2xl relative overflow-hidden">
 <div className="absolute -top-32 -right-32 w-80 h-80 bg-[#FA582D]/10 blur-[80px] rounded-full pointer-events-none" />
 
 <h3 className="text-2xl font-bold text-neutral-900 mb-2 tracking-tight">System Intake & Scope</h3>
 <p className="text-neutral-600 text-sm mb-8">Tell us about your current infrastructure and scale requirements.</p>
 ...
 type="text" 
 required
 className="w-full h-11 rounded-lg border border-black/10 bg-white px-4 text-neutral-900 text-sm outline-none focus:border-[#FA582D] focus:ring-1 focus:ring-[#FA582D] transition-all" 
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
 <div className="space-y-2">
 <label className="text-xs font-bold text-neutral-700 uppercase tracking-wider">Company & Role *</label>
 <input 
 type="text" 
 required
 className="w-full h-11 rounded-lg border border-black/10 bg-white px-4 text-neutral-900 text-sm outline-none focus:border-[#FA582D] focus:ring-1 focus:ring-[#FA582D] transition-all" 
 ...
 <div className="space-y-2">
 <label className="text-xs font-bold text-neutral-700 uppercase tracking-wider">Primary Architecture Focus *</label>
 <select 
 required
 className="w-full h-11 rounded-lg border border-black/10 bg-white px-4 text-neutral-900 text-sm outline-none focus:border-[#FA582D] focus:ring-1 focus:ring-[#FA582D] transition-all appearance-none cursor-pointer"
 >
 ...
 <div className="space-y-2">
 <label className="text-xs font-bold text-neutral-700 uppercase tracking-wider">Current Stack & Concurrency Goals</label>
 <input 
 type="text" 
 className="w-full h-11 rounded-lg border border-black/10 bg-white px-4 text-neutral-900 text-sm outline-none focus:border-[#FA582D] focus:ring-1 focus:ring-[#FA582D] transition-all" 
 ...
 <div className="space-y-2">
 <label className="text-xs font-bold text-neutral-700 uppercase tracking-wider">Key Architectural Challenges</label>
 <textarea 
 rows={4}
 className="w-full rounded-lg border border-black/10 bg-white p-4 text-neutral-900 text-sm outline-none focus:border-[#FA582D] focus:ring-1 focus:ring-[#FA582D] transition-all resize-none" 
