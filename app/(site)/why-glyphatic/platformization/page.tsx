          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {PILLARS.map((pillar, idx) => (
              <FadeInView key={pillar.title} delay={idx * 0.1}>
                <div className="rounded-2xl border border-white/10 bg-[#121212] p-8 md:p-10 h-full relative overflow-hidden group hover:border-[#FA582D]/40 transition-all">
                  <div className="absolute top-0 right-0 p-8 text-white/5 group-hover:text-[#FA582D]/10 transition-colors">
                  ...
                  <p className="text-neutral-400 text-sm leading-relaxed relative z-10">{pillar.description}</p>
                </div>
              </FadeInView>
            ))}
          </div>
          ...
          <div className="space-y-4">
            {COMPARISON.map((item, idx) => (
              <FadeInView key={item.aspect} delay={idx * 0.1}>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 rounded-xl border border-white/5 bg-[#121212] p-6 items-center">
                  <div className="lg:col-span-4 font-bold text-white text-base">
                    {item.aspect}
                  </div>
                  <div className="lg:col-span-4 flex items-center gap-3 text-xs text-neutral-400 bg-red-500/5 p-3 rounded-lg border border-red-500/10">
