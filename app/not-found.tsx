...
export default function NotFound() {
 ...
 <Search className="h-5 w-5 text-neutral-600" />
  ...
  <Link href="/services" className="flex flex-col items-center gap-2 rounded-md border border-neutral-200 bg-white p-6 shadow-sm hover:border-brand-200 hover:shadow-md transition-all">
