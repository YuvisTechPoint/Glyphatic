    ...
    <section className="relative overflow-hidden bg-[#0B1120] py-24 lg:py-32">
      ...
      <div className="container-content relative z-10">
        <FadeInView className="mx-auto max-w-4xl text-center">
          <h2 className="font-display text-display-md text-white md:text-display-lg leading-tight">
            {headline}
          </h2>
          <p className="mt-6 text-body-xl text-neutral-300">
            {subheadline}
          </p>
          <div className="mt-10 flex justify-center">
            <Button variant="primary" size="lg" className="bg-brand-500 hover:bg-brand-600 text-white border-transparent" href={buttonHref}>
              {buttonText}
            </Button>
          </div>
        </FadeInView>
