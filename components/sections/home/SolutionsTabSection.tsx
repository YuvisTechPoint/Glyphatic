...
export function SolutionsTabSection() {
 ...
 <FadeInView>
 <h2 className="font-display text-[2.5rem] md:text-[3rem] lg:text-[3.25rem] leading-[1.1] font-medium text-neutral-900 mb-16">
 ...
 isActive ? 'text-neutral-900' : 'text-gray-400 group-hover:text-neutral-900'
 )}
 >
 {tab.label}
 </span>
 ...
 key={link.href}
 href={link.href}
 className="group flex items-start justify-between gap-4 text-neutral-900 hover:text-[#00E5FF] transition-colors"
 >
