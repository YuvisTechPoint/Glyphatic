...
export function HeroVideoSection() {
 return (
 <section 
 className="hero ai-home-hero theme-dark link-position-underText bg-cover bg-center type-normal relative flex min-h-[85vh] items-center overflow-hidden bg-white lg:min-h-[90vh]" 
 data-type="idira" 
