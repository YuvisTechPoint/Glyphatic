...
export function PlatformizationSection() {
 ...
 <h2 className="text-[26px] md:text-[37.5px] font-medium leading-[1.4] text-neutral-900">
 ...
 className="inline-flex items-center gap-2 rounded-full border border-[#FA582D] px-6 py-2.5 text-[14px] font-bold text-neutral-900 transition-colors hover:bg-[#FA582D]/10"
 >
 ...
 <div 
 key={idx} 
 className="relative flex flex-col justify-between min-h-[460px] md:min-h-[490px] rounded-[28px] border border-white/[0.08] bg-white p-8 md:p-10 overflow-hidden shadow-2xl"
 >
 ...
 <h3 className="text-[24px] md:text-[28px] font-bold text-neutral-900 leading-[1.3] tracking-tight">
 <span className="flex items-baseline flex-wrap gap-x-2.5 gap-y-1 mb-4">
 {stat.prefix && (
 <span className="text-[24px] md:text-[28px] font-bold text-neutral-900 tracking-tight">
 {stat.prefix}
 </span>
 )}
 ...
 <p className="text-[14px] md:text-[15px] text-neutral-600 leading-relaxed font-medium">
 {stat.description}
 </p>
 </div>
 </div>
