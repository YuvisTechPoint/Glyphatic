...
export function TrustedByLogos({ logos = DEFAULT_LOGOS, title, className }: TrustedByLogosProps) {
 ...
 {/* Left/Right Fade Masks */}
  <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-24 bg-gradient-to-r from-gray-50 to-transparent"></div>
  <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-24 bg-gradient-to-l from-gray-50 to-transparent"></div>
 ...
 >
  <span className="text-[13px] md:text-[14px] font-bold uppercase tracking-[0.15em] text-neutral-600 whitespace-nowrap select-none group-hover:text-[#0F4C81] transition-all duration-300">
 {logo.name}
 </span>
 </div>
 ))}
