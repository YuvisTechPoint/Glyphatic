...
const STAT_CARDS = [
 ...
 {/* Cloud Node */}
 <div className="absolute top-[90px] left-[60px] w-16 h-12 bg-[#1a1110] border border-black/10 rounded flex items-center justify-center shadow-[0_0_15px_rgba(250,88,45,0.2)]">
 ...
 {/* Lock Node */}
 <div className="absolute top-[135px] left-[370px] w-14 h-12 bg-[#1a1110] border border-black/10 rounded flex items-center justify-center shadow-[0_0_15px_rgba(250,88,45,0.2)]">
 ...
 <div className="absolute bottom-[-10px] right-[-30px] w-[350px] bg-[#0c0c0c] border border-black/10 rounded-xl shadow-2xl p-5" style={{ transform: 'rotateX(15deg) rotateY(-20deg) rotateZ(5deg)' }}>
 ...
 <span>
 <span className="text-[#FA582D]">function</span> <span className="text-neutral-900">create_category_feeds</span>(<span className="text-[#8ad3de]">$categories</span> = <span className="text-[#a3a3a3]">NULL</span>) {'{'}
 </span>
 </div>
 <div className="flex">
...
export function DefendAtScaleSection() {
 ...
 return (
 <section className="section-padding bg-[#0a0a0a] border-t border-black/5">
 ...
 {STAT_CARDS.map((card) => (
 <FadeInView key={card.id} className={cn("relative min-h-[320px] rounded-2xl overflow-hidden border border-black/5 p-8 flex flex-col justify-end group transition-colors hover:border-[#FA582D]/30", card.colSpan, card.bgClasses)}>
 {card.content}
