      ...
      <div className="container-wide">
        <FadeInView className="flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="md:w-1/2">
            <h2 className="font-display text-[2rem] md:text-[2.5rem] lg:text-[2.75rem] font-medium leading-[1.2] text-white">
              Our customers are securing their <span className="text-[#C84727]">digital transformation</span>
            </h2>
          </div>
          <div className="md:w-1/2 flex justify-start md:justify-end">
            <Link
              href="/customers"
              className="group inline-flex items-center gap-2 text-[15px] font-bold text-white transition-colors hover:text-[#C84727]"
            >
              See testimonials
