...
export function EngageGridSection() {
 ...
 <div className="mb-12 inline-flex items-center gap-1 md:gap-2 p-2 rounded-full border border-black/10 bg-transparent overflow-x-auto max-w-full">
 {TABS.map((tab) => (
 <button
 key={tab.id}
 type="button"
 ...
 <div
 key={card.id}
 className="group flex flex-col xl:flex-row rounded-[1.25rem] bg-white border border-black/5 overflow-hidden transition-colors hover:border-black/20 hover:bg-gray-100"
 >
 {/* Image side */}
 ...
 <h3 className="text-[20px] md:text-[22px] font-medium text-neutral-900 mb-4">
 {card.title}
 </h3>
 <p className="text-[15px] text-neutral-900/70 leading-relaxed mb-8 flex-1">
 {card.description}
 </p>
 <Link
 href={card.href}
